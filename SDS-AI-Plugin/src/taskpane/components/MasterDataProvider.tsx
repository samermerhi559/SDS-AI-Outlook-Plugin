...
interface MasterDataContextType {
  ...
  loadMasterData: (financeUrl: string, authUrl: string) => Promise<void>;
  loadModuleContext: (authUrl: string) => Promise<void>;
...
export const MasterDataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const loadMasterData = async (financeUrl: string, authUrl: string) => {
    try {
      const headers = {
